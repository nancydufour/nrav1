        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center space-x-[2rem] mb-4 w-fit">
              <img src="https://res.cloudinary.com/drnwxb8cm/image/upload/v1756734789/2_rgkois.png" className='object-contain h-[3.5rem] min-[400px]:h-[4.9rem]' alt="NRA logo" />
              <div className="text-sm opacity-70 font-montserrat max-[400px]:hidden text-warm-yellow">powered&nbsp;by</div>
              <img src="https://res.cloudinary.com/drnwxb8cm/image/upload/v1756734789/1_d3ksez.png" className='object-contain h-[3.5rem] min-[400px]:h-[4.9rem]' alt="Her logo" />
            </Link>
