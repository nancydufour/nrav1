...
const Homepage: React.FC = () => {
  ...
  const impactHighlights = [
    ...
    },
    {
      ...
      description:
        "delivering care packs, medical supplies, and emotional support",
      link: "/work",
    },
    {
        ...
        <div className="relative z-10 pt-[3.9rem] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="hero-content">
            ...
            <p className="font-lato text-lg text-gray-300 mb-12 max-w-3xl mx-auto animate-fadeInUp stagger-3">
              Needy Relief Africa exists to meet urgent humanitarian needs while
              building long-term solutions that restore dignity and hope to the
              most vulnerable communities across Africa.
            </p>
      ...
      <section className="py-20 bg-cream">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="font-lato text-lg text-gray-700 leading-relaxed">
            In slums, rural villages, hospitals, and forgotten corners of
            Africa, too many people are living unseen, unheard, and unsupported.
            At Needy Relief Africa, we believe no one should be invisible. We
            are here to fight hunger, heal wounds, create safe spaces, and
            rebuild lives — with dignity at the heart of everything we do.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <AnimatedCard delay={0}>
              <Link
                to="/about"
                className="group bg-white bg-opacity-10 shadow-inner shadow-white backdrop-blur-sm rounded-2xl p-8 hover:bg-opacity-20 transition-all duration-500 transform hover:scale-101 hover:-rotate-1 block"
              >
                <h3 className="font-montserrat font-bold text-2xl text-white mb-4">
                  Our Story
                </h3>
                <p className="font-lato text-gray-200 mb-6">
                  Learn about our mission to restore dignity and hope across
                  Africa.
                </p>
            ...
            <AnimatedCard delay={300}>
              <Link
                to="/green-nose-day"
                className="group bg-white bg-opacity-10 shadow-inner shadow-white backdrop-blur-sm rounded-2xl p-8 hover:bg-opacity-30 transition-all duration-500 transform hover:scale-101 hover:-rotate-1 block"
              >
                <h3 className="font-montserrat font-bold text-2xl text-white mb-4">
